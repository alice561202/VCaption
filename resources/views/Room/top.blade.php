                                ...
                                <div class="jscRoomDetail roomDetail">
                                    <div class="roomDetailInner">
                                        ...
                                        <ul class="roomMemberList">
                                            <li>
                                                ...
                                                <div class="jscModalParent deleteRoomMember buttonWrap">
                                                    <button
                                                        class="jscBtnOpenModal btnDeleteRoomMember button">{{Lang::get('const.common.exit')}}</button>
                                        ...
                                        <div class="addMember">
                                            ...
                                            <div for="addMember"
                                                 class="jscBackgroundLayer backgroundLayer dn"></div>
                                                ...
                                                <form action="">
                                                    ...
                                                    <div class="selectAll buttonWrap">
                                                        <a href="javascript:void(0)"
                                                           class="button">{{Lang::get('const.common.select_all')}}</a>
                                                    </div>
                                        ...
                                        <ul class="actionBtnList">
                                            <li class="jscModalParent startChat buttonWrap">
                                                <button for="startChatRoomId1"
                                                        class="jscBtnOpenModal btnStartChat button">{{Lang::get('const.common.call')}}</button>
                                                <div for="startChatRoomId1"
                                                     class="jscBackgroundLayer backgroundLayer dn"></div>
                                                <div class="jscActionModal actionModal dn">
                                                    <p class="descriptionAction">
                                                        ミーティングを開始しますか？
                                            ...
                                            <li class="jscModalParent deleteChatRoom buttonWrap">
                                                <button for="deleteRoomId1"
                                                        class="jscBtnOpenModal btnDeleteChatRoom button">削除
                                                </button>
                                                <div for="deleteRoomId1"
                                                     class="jscBackgroundLayer backgroundLayer dn"></div>
                                                <div class="jscActionModal actionModal dn">
                                                    <p class="descriptionAction">
                                                    ...
                                                    <ul class="actionBtn">
                                                        <li class="buttonWrap">
                                                            <a href="javascript:void(0);"
                                                               class="jscBtnCancel btnCancel button">キャンセル</a>
                                                        </li>
                                                        <li class="buttonWrap">
